...
begin
  // simula valor recebido do arduino
  valor := 'Dispositivo: ' + TetheringManagerApp.Identifier + ' Valor: ' +
    FloatToStr(40);

    //Preciso Fazer  o totalizador antes de sincroizar...

  TetheringAppProfileApp.SendString(TetheringManagerApp.RemoteProfiles.First,
    'Sincroniza', valor);

  if TetheringAppProfileApp.SendString(TetheringManagerApp.RemoteProfiles.First,
    'Sincroniza', valor) = true then
...
begin
  ...
  EdtQuantidadeLiberar.Enabled := true;
